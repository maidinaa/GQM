							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="{{$tester->getAvatar()}}" class="img-circle" alt="Avatar">
										<h3 class="name">{{$tester->nama}}</h3>
								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<ul class="list-unstyled list-justify">
											<li>perusahaan <span>{{$tester->perusahaan}}</span></li>
									...
									<div class="text-center"><a href="/tester/{{$tester->id}}/edit" class="btn btn-warning">Edit Profile</a></div>
								</div>
								<!-- END PROFILE DETAIL -->
							</div>
							<!-- END LEFT COLUMN -->
